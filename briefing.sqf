...
<br/>
	...
	404 Developers: - Deadbeat - Costlyy - Pulse - DomUK<br/>
	Zargabad Port and Edits: Bisto.<br/>
	With help and scripts from: MaRker, Melbo and Kettlewell<br/>
 Server Host - Bisto and ITFN Clan<br/><br/>
"
]
];
...
"
<br/>
	DO NOT CAMP GUNSTORE.<br/>
	NO TEAM KILLING ON BLUFOR OR OPFOR.<br/>
	ALL TWS WEAPONS ARE BANNED.<br/>
	KEEP ALL TRAFFIC ON GLOBAL TO A MININIUM.<br/>
	The ONLY permitted excuse for voice in global is for seeking admin's attention, please do so in english.<br/>
	SIDE CHANNEL VOICE IS FINE AS LONG AS:<br/>
	A. YOU SPEAK IN ENGLISH CLEARLY SO ALL CAN UNDERSTAND.<br/>
	B. YOU ARE NOT CONSTANTLY CLOGGING UP YOUR TEAMS RADIO CHANNEL / BEING A PRICK.<br/>
	NO RACISM.<br/>
	ANY PLAYER FOUND SCRIPTING OR HACKING ON THIS SERVER WILL BE BANNED AND REPORTED.<br/>
	ADMINS FOR THIS SERVER ARE: Bisto, Shaydeeadi, Tom, Mangoman and Pricie.<br/>
	PLAY FAIR, RESPECT FELLOW PLAYERS, RESPECT ADMINS OR GET BANNED.<br/><br/>
"
]
];
