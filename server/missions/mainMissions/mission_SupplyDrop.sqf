...
fn_supplydrop = {
Waituntil {((_plane distance getmarkerPos "supplytext") < 1500) OR ((damage _plane) == 1)
};

if((damage _plane) == 1) then {
_hint = parseText format ["<t align='center' color='%4' shadow='2' size='1.75'>Supply Drop fail!</t><br/><t align='center' color='%4'>------------------------------</t><br/><t align='center' color='%5' size='1.25'>%1</t><br/><t align='center'><img size='5' image='%2'/></t><br/><t align='center' color='%5'>The<t color='%4'> %3</t>, has crashed.</t>", _missionType, _picture, _vehicleName, _mainTextColour, _subTextColour];
...
Waituntil {((_plane distance getmarkerPos "supplytext") < 200) OR ((damage _plane) == 1)
};
...
_hint = parseText format ["<t align='center' color='%4' shadow='2' size='1.75'>Supply Drop fail!</t><br/><t align='center' color='%4'>------------------------------</t><br/><t align='center' color='%5' size='1.25'>%1</t><br/><t align='center'><img size='5' image='%2'/></t><br/><t align='center' color='%5'>The<t color='%4'> %3</t>, WTF</t>", _missionType, _picture, _vehicleName, _mainTextColour, _subTextColour];
} else {
//check for the plane crash
if((damage _plane) == 1) then {
_hint = parseText format ["<t align='center' color='%4' shadow='2' size='1.75'>Supply Drop fail!</t><br/><t align='center' color='%4'>------------------------------</t><br/><t align='center' color='%5' size='1.25'>%1</t><br/><t align='center'><img size='5' image='%2'/></t><br/><t align='center' color='%5'>The<t color='%4'> %3</t>, has crashed.</t>", _missionType, _picture, _vehicleName, _mainTextColour, _subTextColour];
[nil,nil,rHINT,_hint] call RE;
deletevehicle _plane;
...
Waituntil {
((_plane distance getmarkerPos "supply") > 4000) OR ((damage _plane) == 1)
};
